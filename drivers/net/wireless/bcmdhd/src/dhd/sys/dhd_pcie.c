...
#if defined(CONFIG_ARCH_EXYNOS) && defined(CUSTOMER_HW4)
				OSL_SLEEP(200);
#endif /*                                    */
#ifdef CONFIG_ARCH_MSM
...
void dhdpcie_l1ss_set(osl_t *osh)
{
	...
	OSL_PCI_WRITE_CONFIG(osh, PCI_LINK_CTRL, 4, 0x143);
	OSL_PCI_WRITE_CONFIG(osh, PCIE_LTR_MAX_SNOOP, 4, 0x10031003);
	OSL_PCI_WRITE_CONFIG(osh, PCI_DEV_STAT_CTRL2, 4, 0);
