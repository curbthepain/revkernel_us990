...
extern int broadcast_drv_if_open_fci(void);
extern int broadcast_drv_if_close_fci(void);
extern int broadcast_drv_if_set_channel_fci(unsigned int freq_num, unsigned int subch_id, unsigned int op_mode);
extern int broadcast_drv_if_detect_sync_fci(int op_mode);
extern int broadcast_drv_if_get_sig_info_fci(struct broadcast_tdmb_sig_info *dmb_bb_info);
extern int broadcast_drv_if_get_ch_info_fci(char* buffer, unsigned int* buffer_size);
extern int broadcast_drv_if_get_dmb_data_fci(char** buffer_ptr, unsigned int* buffer_size, unsigned int user_buffer_size);
extern int broadcast_drv_if_reset_ch_fci(void);
extern int broadcast_drv_if_user_stop_fci(int mode);
