...
static u32 tunning_mode_4[57][7] = { /*            */
...
s32 fc8300_es2_set_freq(HANDLE handle, DEVICEID devid, u32 freq)
{
	...
	} else if (bc_type_freq == ISDBTMM_1SEG) {   /*        */
		for (i = 0; i < 8; i++) {
	...
	} else if (bc_type_freq == ISDBTMM_13SEG) {  /*       */
		for (i = 0; i < 40; i++) {
