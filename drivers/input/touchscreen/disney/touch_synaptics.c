...
#define THERMAL_UPDATE_INTERVAL_REG     0x2F      /*        */
...
#define GUEST_THREAD_DATA_SWIPE_0_REG	0x68	//           
#define GUEST_THREAD_DATA_SWIPE_1_REG	0x6a	//                  
#define GUEST_THREAD_DATA_SWIPE_2_REG	0x6c	//                         
#define GUEST_THREAD_DATA_SWIPE_3_REG	0x6e	//                         
#define GUEST_THREAD_DATA_SWIPE_4_REG	0x70	//                       
#define GUEST_THREAD_DATA_SWIPE_5_REG	0x72	//                       
#define GUEST_THREAD_DATA_SWIPE_6_REG	0x74	//           
...
static int sleep_control(struct synaptics_ts_data *ts, int mode, int recal)
{
  ...
  */
	...
	//      
	{
		...
		|| !strncmp(ts->fw_info.fw_product_id, "PLG449", 6)
		|| !strncmp(ts->fw_info.fw_product_id, "PLG503", 6)) {
			if (((curr & 0xF8) == DEVICE_CONTROL_SLEEP) && !mode) { /*                            */
...
static int lpwg_control(struct synaptics_ts_data *ts, int mode)
{
	...
	case LPWG_DOUBLE_TAP:                         /*            */
		...
		tci_control(ts, MIN_INTERTAP_CTRL, 6); /*              
                */
	...
	case LPWG_PASSWORD:                           /*                 */
		...
		tci_control(ts, TAP_COUNT_CTRL2,
				(u8)ts->pw_data.tap_count); /*          
                             */
		tci_control(ts, MIN_INTERTAP_CTRL2, 6); /*              
                 */
