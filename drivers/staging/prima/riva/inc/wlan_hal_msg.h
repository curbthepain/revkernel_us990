...
typedef PACKED_PRE struct PACKED_POST
{
    ...
    tANI_U8                  ssid[33];                  //                     
    tANI_U8                  bssid[6];                  //      
    tANI_U8                  ap_country_str[3];         //                                
    tANI_U8                  country_str[3];            //                                    
} wifi_interface_info;
...
typedef PACKED_PRE struct PACKED_POST
{
    ...
    tANI_U32   tx_time;                    //                                                                    
    tANI_U32   rx_time;                    //                                                                         
    tANI_U32   on_time_scan;               //                                                                             
    tANI_U32   on_time_nbd;                //                                                                        
    tANI_U32   on_time_gscan;              //                                                                           
    tANI_U32   on_time_roam_scan;          //                                                                              
    tANI_U32   on_time_pno_scan;           //                                                                             
    tANI_U32   on_time_hs20;               //                                                                                                 
    tANI_U32   num_channels;               //                   
    wifi_channel_stats channels[1];        //                   
} wifi_radio_stat;
...
typedef PACKED_PRE struct PACKED_POST
{
    ...
    tANI_U32 mpdu_lost;      //                                      
    tANI_U32 retries;        //                                   
    tANI_U32 retries_short;  //                                 
    tANI_U32 retries_long;   //                                
} wifi_rate_stat;
...
typedef PACKED_PRE struct PACKED_POST
{
    ...
    tANI_U32 retries_short;              //                                 
    tANI_U32 retries_long;               //                                
    tANI_U32 contention_time_min;        //                                     
    tANI_U32 contention_time_max;        //                                     
    tANI_U32 contention_time_avg;        //                                     
    tANI_U32 contention_num_samples;     //                                                
} wifi_wmm_ac_stat;
...
typedef PACKED_PRE struct PACKED_POST
{
    ...
    tANI_U32            beacon_rx;                                  //                                                     
    tANI_U32            mgmt_rx;                                    //                                                                             
    tANI_U32            mgmt_action_rx;                             //                             
    tANI_U32            mgmt_action_tx;                             //                             
    tANI_U32            rssi_mgmt;                                  //                                                          
    tANI_U32            rssi_data;                                  //                                                           
    tANI_U32            rssi_ack;                                   //                                                   
    wifi_wmm_ac_stat    AccessclassStats[WIFI_AC_MAX];              //                              
} wifi_iface_stat;
...
typedef PACKED_PRE struct PACKED_POST
{
   tANI_U32  req_id;
   tANI_U8   sta_id;
   tANI_U32  mpdu_size_threshold;             //                                                
   tANI_U32  aggressive_statistics_gathering; //                                                                                                 
...
typedef enum
{
   ...
   EXT_SCAN_CHANNEL_BAND_BG           = 0x0001,    //        
   EXT_SCAN_CHANNEL_BAND_A            = 0x0002,    //                  
   EXT_SCAN_CHANNEL_BAND_A_DFS        = 0x0004,    //               
   EXT_SCAN_CHANNEL_BAND_A_WITH_DFS   = 0x0006,    //               
   EXT_SCAN_CHANNEL_BAND_ABG          = 0x0003,    //                        
   EXT_SCAN_CHANNEL_BAND_ABG_WITH_DFS = 0x0007,    //                         
