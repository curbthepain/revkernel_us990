...
{
    eRRM_MSG_SOURCE_LEGACY_ESE  = 1, /*            */
    eRRM_MSG_SOURCE_11K         = 2, /*     */
    eRRM_MSG_SOURCE_ESE_UPLOAD  = 3  /*                     */
} tRrmMsgReqSource;
...
typedef struct sSirBeaconReportReqInd
{
   ...
   tANI_U16     length;
   tSirMacAddr  bssId;
   tANI_U16     measurementDuration[SIR_ESE_MAX_MEAS_IE_REQS];   //  
   tANI_U16     randomizationInterval; //  
   tSirChannelInfo channelInfo;
   tSirMacAddr      macaddrBssid;   //           
   tANI_U8      fMeasurementtype[SIR_ESE_MAX_MEAS_IE_REQS];  //                                   
   tAniSSID     ssId;              //               
