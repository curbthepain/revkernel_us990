...
typedef enum
{
   WDI_TX_RATE_LEGACY = 0x1,    /*              */
   WDI_TX_RATE_HT20   = 0x2,    /*            */
   WDI_TX_RATE_HT40   = 0x4,    /*            */
   WDI_TX_RATE_SGI    = 0x8,    /*                                */
   WDI_TX_RATE_LGI    = 0x10,   /*                               */
   WDI_TX_RATE_VHT20  = 0x20,   /*              */
   WDI_TX_RATE_VHT40  = 0x40,   /*              */
   WDI_TX_RATE_VHT80  = 0x80,   /*              */
   WDI_TX_RATE_VIRT   = 0x100,  /*              */
} WDI_TxRateFlags;
...
typedef struct
{
     ...
     */
    wpt_int32 reliableMcastDataRate; //            
...
typedef struct
{
    wpt_uint8     cmdType;
    wpt_uint8     scanType;
    wpt_uint16    OBSSScanPassiveDwellTime; //       
    wpt_uint16    OBSSScanActiveDwellTime;  //       
    wpt_uint16    BSSChannelWidthTriggerScanInterval; //           
    wpt_uint16    OBSSScanPassiveTotalPerChannel; //       
    wpt_uint16    OBSSScanActiveTotalPerChannel;  //       
...
typedef enum
{
    ...
    WDI_WIFI_BAND_A              = 2,    //                  
    WDI_WIFI_BAND_ABG            = 3,    //                        
    WDI_WIFI_BAND_A_DFS          = 4,    //               
    WDI_WIFI_BAND_A_WITH_DFS     = 6,    //               
    WDI_WIFI_BAND_ABG_WITH_DFS   = 7,    //                         
...
typedef struct
{
    ...
    wpt_int32   numAp;        //                      
    WDI_APThresholdParam   ap[WDI_WLAN_EXTSCAN_MAX_HOTLIST_APS];    //            
