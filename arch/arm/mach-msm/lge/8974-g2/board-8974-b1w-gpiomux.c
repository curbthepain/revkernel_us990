...
static int gpio_reserved_pin_rev_A[] = {
	4, 73, 75, 100, 102, 104, 105, 106, 107, 108, 109, 113, 115, 117, 118,
	119, 120, 126, 127, 129, 130, 131, 132, 137,
	MSM8974_GPIO_END
};

static int gpio_reserved_pin_rev_B[] = {
	4, 23, 24, 25, 26, 73, 74, 75, 100, 102, 104, 105, 106, 107, 108, 109, 113, 115, 117, 118,
	119, 120, 126, 127, 129, 130, 131, 132, 137,
	MSM8974_GPIO_END
};
...
/*                                                                            */
	...
	switch ( lge_get_board_revno() ) {
		...
		case HW_REV_1_1 :
		default :
			for ( gpio_index = 0 ; gpio_reserved_pin_rev_B[gpio_index] < MSM8974_GPIO_END ;	gpio_index++ ) {
				gpio_func_reserved_pin_config.gpio = gpio_reserved_pin_rev_B[gpio_index];
				msm_gpiomux_install(&gpio_func_reserved_pin_config, 1);
			}
			break;
