...
/*                                                          */
/*                         */
static struct gpiomux_setting wm5110_reset = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting wm5110_int = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct msm_gpiomux_config msm_wm5110_configs[] __initdata = {
	{
		/*     */
		.gpio = 93,
		.settings = {
			[GPIOMUX_SUSPENDED] = &wm5110_int,
		},
	},
	{
		/*          */
		.gpio = 63,
		.settings = {
			[GPIOMUX_SUSPENDED] = &wm5110_reset,
		},
	},
};

static struct gpiomux_setting wm5110_spi_active_config = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting wm5110_spi_cs_suspend_config = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};

static struct gpiomux_setting wm5110_spi_suspend_config = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};
...
/*                                                          */
#ifdef CONFIG_MACH_LGE
	{
		.gpio      = 53,		/*                          */
		.settings = {
			[GPIOMUX_ACTIVE] = &wm5110_spi_active_config,
			[GPIOMUX_SUSPENDED] = &wm5110_spi_suspend_config,
		},
	},
	{
		.gpio      = 54,		/*                          */
	...
	},
	{
		...
		.settings = {
			[GPIOMUX_ACTIVE] = &wm5110_spi_active_config,
			[GPIOMUX_SUSPENDED] = &wm5110_spi_cs_suspend_config,
		},
	},
#else
	{
...
static struct gpiomux_setting vibrator_active_cfg_gpio69 = {
       .func = GPIOMUX_FUNC_6,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config vibrator_configs[] = {
	{
		.gpio = 69,
		.settings = {
			[GPIOMUX_ACTIVE]    = &vibrator_active_cfg_gpio69,
